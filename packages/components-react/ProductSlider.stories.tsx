...
// Note: Only description is HTML from CMS rich text editor, all other fields are plain text
const allProducts = [
  {
    id: 1,
    image: pepsiMaxImage,
...
export default {
          ...
          detail: `[
  {
    ...
    title: string (plain text - not from CMS),
    description: string (HTML from CMS rich text editor, e.g., "<p>Text</p>"),
    buttonLabel: string (plain text - not from CMS),
    buttonHref: string (plain text - URL),
    buttonOnClick: function (optional)
  }
]`,
        },
      },
...
export const CustomHeadline = {
  args: {
    headline: 'Discover Our Range',
    subheadline: '<p>Explore our delicious selection of refreshing beverages</p>',
    products: allProducts,
  },
};
